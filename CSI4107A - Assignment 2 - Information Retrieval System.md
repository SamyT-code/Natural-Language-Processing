...
## References
- Daoust, M. (2024, March 10). _Universal sentence encoder  :  tensorflow hub_. TensorFlow. https://www.tensorflow.org/hub/tutorials/semantic_similarity_with_tf_hub_universal_encoder
- Reimers, N. (2024). _Pretrained models¶_. Pretrained Models - Sentence-Transformers documentation. https://www.sbert.net/docs/pretrained_models.html